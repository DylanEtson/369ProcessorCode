...
module DataMemory(Address, WriteData, Clk, MemWrite, MemRead, ReadData); 
    ...
    //copy pasted from Instruction Memory. Need to expand to 1K registers and a signal wide enough to access them
    
    reg [31:0] memory [0:1023]; //Local memory. 128 words.
    ...
    assign ReadData = (MemRead == 1) ? memory[Address[11:2]] :
                      32'd0; 
